...
//                     <ul>
//                         <li>
//                             <a href="copyright.html">BẢN QUYỀN</a>
//                         </li>
//                         <li> 
//                             <a href="">QUẢNG CÁO</a>
//                         </li>
...
//                                         </td>
//                                         <td>
//                                             <textarea className="col-9"  name="noidung" type="text" id="ykien" required></textarea>
//                                         </td>
//                                     </tr>
//                                     <tr>
//                                         <td>
//                                             <th colspan="2"><input className="button" type="submit" value="Gửi" onclick="myFunction()" /></th>
//                                         </td>
//                                     </tr>
//                                 </table>
//                                 </form>
